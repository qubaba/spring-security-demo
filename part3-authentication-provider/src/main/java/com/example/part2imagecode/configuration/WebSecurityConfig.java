...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Resource
    private VerificationCodeUserDetailAuthenticationProvider verificationCodeUserDetailAuthenticationProvider;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authenticationProvider(verificationCodeUserDetailAuthenticationProvider);
    }
}
